...
import { idlFactory } from './3rp_api.did.js';
export { idlFactory } from './3rp_api.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.3RP_API_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./3rp_api.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the 3rp_api canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./3rp_api.did.js")._SERVICE>}
 */
export const 3rp_api = createActor(canisterId);
